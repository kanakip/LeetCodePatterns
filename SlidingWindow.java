...
public class SlidingWindow {
  // It taks O(n*k) tim complxity - fixed size
  ...
  //Dynamic sliding window - O(n) - time complexity, spac complexity - O(k)
  ...
  // with frquency - dynamic sliding window -  O(n) - time complexity, spac complexity - O(k)
